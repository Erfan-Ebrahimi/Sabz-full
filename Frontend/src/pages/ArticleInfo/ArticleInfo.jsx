            ...
            <div class="row">
              <div class="col-8">
                ...
                <div class="article">
                  ...
                  <img src={img} alt="Article Cover" class="article__banner" />

                  <div class="article__score">
                    <div class="article__score-icons">
                      <img src={star} class="article__score-icon" />
                      <img src={star} class="article__score-icon" />
                      <img src={star} class="article__score-icon" />
                      <img src={star} class="article__score-icon" />
                      <img src={star} class="article__score-icon" />
                  ...
                  <img src={img} alt="Article Image" class="article__seconadary-banner" />
                  <div class="article-section">
                    ...
                    <img src={img} alt="article body img" class="article-section__img" />
                  </div>
                  <div class="article-section">
                    <h2 class="article-section__title">
                      معرفی بهترین سایت ‌های آموزش جاوا اسکریپت:
